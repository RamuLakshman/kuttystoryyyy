...
select.select_by_value("Conceived")
sleep(6)
...
# picture1=driver.find_element(By.XPATH,("(//div[@class='row form_split_bg']/button[@id='crop-btn'])[1]")).click()
sleep(6)
"""
